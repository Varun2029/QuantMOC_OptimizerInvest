...
MARKETS = {
    "india": {
        ...
        "currency": "₹",
        "index": "NIFTY 50",
        "volatility": "^VIX",  # India VIX often unavailable; use global
        "equity": ["RELIANCE.NS", "TCS.NS", "HDFCBANK.NS", "INFY.NS", "ICICIBANK.NS", "SBIN.NS"],
        "etfs": ["NIFTYBEES.NS", "BANKBEES.NS"],  # Nifty ETF, Bank ETF
        "bonds": ["ICICIGILT.NS"],  # Gilt fund
        "gold": ["GOLDBEES.NS"],
    },
    "usa": {
        "name": "USA",
    ...
    "uk": {
        ...
        "currency": "£",
        "index": "FTSE 100",
        "volatility": "^VIX",  # UK has no direct VIX
        "equity": ["HSBA.L", "SHEL.L", "AZN.L", "ULVR.L", "GSK.L", "BP.L"],
        "etfs": ["ISF.L", "VUSA.L"],  # FTSE 100, S&P 500
        "bonds": ["VGOV.L"],  # UK Gilt ETF
        "gold": ["SGLN.L"],
    },
}
...
MARKET_TICKERS = {
    "india": ["RELIANCE.NS", "TCS.NS", "HDFCBANK.NS", "NIFTYBEES.NS", "GOLDBEES.NS", "ICICIGILT.NS"],
